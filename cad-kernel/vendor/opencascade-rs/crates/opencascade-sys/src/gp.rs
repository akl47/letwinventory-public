...
mod inner {
    unsafe extern "C++" {
        ...
        /// Mirror across the XY plane of the given gp_Ax2 coordinate
        /// system (i.e. reflect across the plane perpendicular to the
        /// Ax2's main direction). Required for Mirror Feature — the
        /// Ax1 variant above is a 180° axial rotation, not plane
        /// reflection.
